    ...
    <>
      ...
      >
        <p className="mb-7 text-lg leading-[1.8] text-black/70 dark:text-white/60">
          ...
          or on-demand expertise, our model integrates seamlessly into your
          operations.
        </p>
        ...
        <p className="mb-7 text-lg leading-[1.8] text-black/70 dark:text-white/60">
          ...
          achieving your goals. With our industry expertise, we handle
          complexities so you can focus on growth and innovation.
        </p>
      </ServiceShowcaseSection>
    </>
  );
...
export default GCCServicesInfo;

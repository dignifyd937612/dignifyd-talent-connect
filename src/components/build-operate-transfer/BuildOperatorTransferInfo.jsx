...
const BuildOperatorTransferInfo = () => {
  return (
    <>
      ...
      >
        <p className="mb-7 text-lg leading-[1.8] text-black/70 dark:text-white/60">
          ...
          seamlessly hand over new operations to your team. We manage setup,
          day-to-day operations, and ongoing oversight - ensuring efficiency and
...
export default BuildOperatorTransferInfo;

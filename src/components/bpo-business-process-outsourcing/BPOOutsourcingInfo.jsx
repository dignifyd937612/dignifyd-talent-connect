    ...
    <>
      ...
      >
        <p className="mb-7 text-lg leading-[1.8] text-black/70 dark:text-white/60">
          ...
          shoulders. By outsourcing critical functions to our experienced teams,
          you can focus on what matters most-growing your business. We use
          cutting-edge technology and proven methodologies to deliver tailored
          solutions that enhance efficiency, improve customer satisfaction, and
          reduce costs.
        </p>
...
export default BPOOutsourcingInfo;

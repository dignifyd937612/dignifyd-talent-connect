    ...
    <>
      <ServiceShowcaseSection heading="Upskilling" supportingHeading="Academy">
        <p className="mb-7 text-lg leading-[1.8] text-black/70 dark:text-white/60">
          ...
          Hire, Train, & Deploy (HTD) model ensures you get job-ready talent
        ...
        <p className="mb-7 text-lg leading-[1.8] text-black/70 dark:text-white/60">
          ...
          productivity, reduce hiring time, and future-proof your workforce. By
          identifying skill gaps and delivering hands-on, real-world training,
          we empower your workforce to meet current challenges and seize future
          opportunities.
        </p>
...
export default UpskillingAcademyInfo;
